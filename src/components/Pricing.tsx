      ...
      <div className="mx-auto max-w-6xl px-6">
        <FadeIn className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-balance text-[17px] leading-relaxed text-white/55">
            One flat project fee. No retainers, no surprise invoices. These
            rates go up once I have a full portfolio — lock them in now.
          </p>
        </FadeIn>
            ...
            <StaggerItem key={plan.name}>
              <motion.div
                ...
                className={`relative flex h-full flex-col rounded-3xl p-8 ${
                  plan.featured
                    ? "border border-accent/40 bg-gradient-to-b from-white/[0.09] to-white/[0.02] shadow-[0_20px_60px_-15px_rgba(47,214,122,0.25)]"
                    : "glass"
                }`}
              >
                {plan.featured && (
                  <span className="absolute -top-3 left-1/2 -translate-x-1/2 rounded-full bg-accent px-4 py-1 text-[11px] font-semibold uppercase tracking-wide text-[#04150c]">
                    Best value
                  </span>
                )}
