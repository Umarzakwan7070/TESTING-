    ...
    >
      ...
      >
        <a href="#top" className="flex items-center gap-2 text-[15px] font-semibold tracking-tight text-white">
          <span className="flex h-7 w-7 items-center justify-center rounded-full bg-gradient-to-br from-[var(--accent-1)] via-[var(--accent-3)] to-[var(--accent-2)]">
        ...
        {open && (
          ...
          >
            ...
            <a
              href="#contact"
              onClick={() => setOpen(false)}
              className="mt-2 rounded-xl bg-white px-4 py-3 text-center text-[15px] font-semibold text-black"
            >
              Book a call
            </a>
          </motion.div>
