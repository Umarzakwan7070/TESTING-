      ...
      <div className="mx-auto max-w-5xl px-6">
        ...
        <div ref={ref} className="relative mt-20">
          ...
          <motion.div
            ...
            className="absolute left-[27px] top-0 w-px bg-gradient-to-b from-[var(--accent-1)] via-[var(--accent-3)] to-[var(--accent-2)] md:left-1/2"
          />
          ...
          <div className="flex flex-col gap-14">
            {STEPS.map((step, i) => (
              ...
              >
                <div className="relative z-10 flex h-14 w-14 shrink-0 items-center justify-center rounded-full border border-white/10 bg-[var(--surface)] text-sm font-semibold text-white">
                  {step.n}
                </div>
