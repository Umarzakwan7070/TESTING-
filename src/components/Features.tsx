        ...
        <Stagger className="mt-16 grid grid-cols-1 gap-4 md:grid-cols-3">
          {FEATURES.map((f) => (
            <StaggerItem key={f.title} className={f.span}>
              ...
              >
                <div className="pointer-events-none absolute -right-10 -top-10 h-40 w-40 rounded-full bg-[var(--accent-1)] opacity-0 blur-3xl transition-opacity duration-500 group-hover:opacity-20" />
